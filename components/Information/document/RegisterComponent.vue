    ...
    <form @submit.prevent="handleSubmit">
      ...
      <div class="">
        <button
          ...
          class="border mb-4 text-[13px] border-primary- uppercase text-white w-full min-w-[55px] bg-primary-500 text-center opacity-80 rounded-full px-6 py-2 hover:opacity-100 h-12"
        >
          <span v-if="isLoading"
            >Signing up
            <i
