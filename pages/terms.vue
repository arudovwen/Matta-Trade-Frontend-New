<template>
  ...
  >
    <div class="pt-10 pb-24  px-4 md:px-6">
      ...
      <article>
        <p>
          <span class="font-bold">THE AGREEMENT:</span> The use of this website
          and services on this website provided by MATTA TRADE (hereinafter
          referred to as "Company") are subject to the following Terms &
          Conditions (hereinafter the "Agreement"), all parts and sub-parts of
          which are specifically incorporated by reference here. This Agreement
          shall govern the use of all pages on this website (hereinafter
          collectively referred to as "Website") and any services provided by or
          on this Website ("Services").
        </p>
        <ul class="list-disc pl-4 text-sm mb-10">
          <li class="!mb-10">
            <h4>DEFINITIONS</h4>
            <p>
            ...
            <ul class="list-disc pl-6 md:pl-10 text-sm mb-10">
              ...
              <li>
                MATTA TRADE, Company, Us, We, Our, Ours and other first-person
          ...
          <li class="!mb-10">
            ...
            <p>
              ...
              Website or any Services contained herein. By using this Website,
              You represent and warrant that You are at least 18 years of age
              and may legally agree to this Agreement. The Company assumes no
          ...
          <li class="!mb-10">
            ...
            <ul class="list-disc pl-6 md:pl-10 text-sm mb-10">
              <li>
                In order to make the Website and Services available to You, You
                hereby grant the Company a royalty-free, non-exclusive,
              ...
              <li>
                ...
                been infringed or otherwise violated by the posting of
                information or media by another of Our users, please contact Us
                and let Us know.
              </li>
            </ul>
          </li>
          ...
          <li class="!mb-10">
            ...
            <p>
              ...
              You authorize the Company to use Your information in the United
              States and any other country where We may operate.
            </p>
            <ul class="list-disc pl-6 md:pl-10 text-sm mb-10">
              <li>
                Information We May Collect or Receive: When You register for an
                account, You provide Us with a valid email address and may
                ...
                applications that You use to access Our Website, or We may
                receive information through various web technologies, such as
                cookies, log files, clear gifs, web beacons or others.
              </li>
              <li>
                How We Use Information: We use the information gathered from You
                to ensure Your continued good experience on Our website,
              ...
              <li>
                How You Can Protect Your Information: If You would like to
                ...
                following number of days: 2. After that time, it will be
                deleted.
              </li>
            </ul>
          </li>
          ...
          <li class="!mb-10">
            <h4>SALES</h4>
            <p>
              The Company allows third parties to sell goods and services on the
              Website. The Company undertakes to be as accurate as possible with
              all information regarding the goods and services, including
              product descriptions and images. However, the Company does not
          ...
          <li class="!mb-10">
            ...
            <ul class="list-disc pl-6 md:pl-10 text-sm mb-10">
              ...
              <li>
                ...
                Agreement. You agree that Your continued use of the Website
              ...
              <li>
                ...
                variations of this Agreement, You agree that such failure shall
          ...
          <li class="!mb-10">
            ...
            <ul class="list-disc pl-6 md:pl-10 text-sm mb-10">
              <li>
                <span class="font-bold">LANGUAGE:</span> All communications made
                or notices given pursuant to this Agreement shall be in the
                English language.
              </li>
              <li>
                <span class="font-bold">
                  JURISDICTION, VENUE & CHOICE OF LAW:</span
                >
                Through Your use of the Website or Services, You agree that the
                laws of the Federal Republic of Nigeria shall govern any matter
                or dispute relating to or arising out of this Agreement, as well
                as any dispute of any kind that may arise between You and the
                Company, with the exception of its conflict of law provisions.
                In case any litigation specifically permitted under this
                Agreement is initiated, the Parties agree to submit to the
                personal jurisdiction of federal courts of the Federal Republic
                of Nigeria. The Parties agree that this choice of law, venue,
                and jurisdiction provision is not permissive, but rather
                mandatory in nature. You hereby waive the right to any objection
                of venue, including assertion of the doctrine of forum non
                conveniens or similar doctrine.
              </li>
              <li>
                <span class="font-bold">ARBITRATION: </span>In case of a dispute
                between the Parties relating to or arising out of this
                Agreement, the Parties shall first attempt to resolve the
                dispute personally and in good faith. If these personal
                resolution attempts fail, the Parties shall then submit the
                dispute to binding arbitration.The arbitration shall be
                conducted by a single arbitrator, and such arbitrator shall have
                no authority to add Parties, vary the provisions of this
                Agreement, award punitive damages, or certify a class. The
                arbitrator shall be bound by applicable and governing Federal
                law. Each Party shall pay their own costs and fees. Claims
                necessitating arbitration under this section include, but are
                not limited to: contract claims, tort claims, claims based on
                Federal and state law, and claims based on local laws,
                ordinances, statutes or regulations. Intellectual property
                claims by the Company will not be subject to arbitration and
                may, as an exception to this sub-part, be litigated. The
                Parties, in agreement with this sub-part of this Agreement,
                waive any rights they may have to a jury trial in regard to
                arbitral claims.
              </li>
              <li>
                <span class="font-bold">ASSIGNMENT:</span>This Agreement, or the
                rights granted hereunder, may not be assigned, sold, leased or
              ...
              <li>
                <span class="font-bold"> SEVERABILITY:</span> If any part or
                sub-part of this Agreement is held invalid or unenforceable by a
                court of law or competent arbitrator, the remaining parts and
                sub-parts will be enforced to the maximum extent possible. In
                such condition, the remainder of this Agreement shall continue
                in full force.
              </li>
              <li>
                <span class="font-bold"> NO WAIVER:</span> In the event that We
                fail to enforce any provision of this Agreement, this shall not
              ...
              <li>
                <span class="font-bold"> HEADINGS FOR CONVENIENCE ONLY: </span>
              ...
              <li>
                <span class="font-bold">
                  NO AGENCY, PARTNERSHIP OR JOINT VENTURE:</span
                >
                No agency, partnership, or joint venture has been created
                between the Parties as a result of this Agreement. No Party has
                any authority to bind the other to third parties.
              </li>
              <li>
                <span class="font-bold"> FORCE MAJEURE: </span> The Company is
                not liable for any failure to perform due to causes beyond its
                reasonable control including, but not limited to, acts of God,
                acts of civil authorities, acts of military authorities, riots,
                embargoes, acts of nature and natural disasters, and other acts
                which may be due to unforeseen circumstances.
              </li>
              <li>
                <span class="font-bold">
                  ELECTRONIC COMMUNICATIONS PERMITTED:</span
                >
